...
final class LoadMineablesCommandTest extends ScDataTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $salvageClusterPath = $this->writeFile(
            ...
            sprintf(
                '<HarvestableClusterPreset.SalvageClusterLarge probabilityOfClustering="100" __type="HarvestableClusterPreset" __ref="%1$s" __path="libs/foundry/records/harvestable/clusteringpresets/sample_salvage_cluster.xml"><params><HarvestableClusterSpawnParams relativeProbability="1" minSize="5" maxSize="10" minProximity="5" maxProximity="10" /></params></HarvestableClusterPreset.SalvageClusterLarge>',
                self::SALVAGE_CLUSTER_UUID,
            )
        );
    ...
    public function test_execute_exports_index_and_locations_into_mineables_folder(): void
    {
        ...
        self::assertCount(3, $mineables);
        self::assertSame(['Sample Entity One', 'Sample Entity Two', 'SampleAsteroidMineable'], array_column($mineables, 'name'));
        ...
        self::assertSame(5, $locationsByProvider['HPP_SpaceDerelict_General']['groups'][0]['deposits'][0]['relativeProbability']);
        ...
        self::assertSame(100, $locationsByProvider['HPP_SpaceDerelict_General']['groups'][0]['deposits'][0]['clustering']['probability_of_clustering']);
        ...
        self::assertCount(2, $locationsByProvider['HPP_Stanton1']['groups'][0]['deposits']);
        ...
        self::assertSame(3, $locationsByProvider['HPP_Stanton1']['groups'][0]['deposits'][0]['relativeProbability']);
        ...
        self::assertSame(1, $locationsByProvider['HPP_Stanton1']['groups'][0]['deposits'][1]['relativeProbability']);
