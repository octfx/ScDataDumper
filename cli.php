...
$application->addCommand(new LoadCommodities);
$application->addCommand(new LoadContracts);
$application->addCommand(new LoadVehicles);
$application->addCommand(new LoadFactions);
$application->addCommand(new LoadStarmap);
$application->addCommand(new LoadCommodityTradeLocations);
