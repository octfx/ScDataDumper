...
use Generator;
use JsonException;
use Octfx\ScDataDumper\Definitions\AmmoParams;
...
final class AmmoParamsService extends BaseService
{
    ...
    public function getByEntity(EntityClassDefinition $item): ?AmmoParams
    {
    ...
    public function load(string $filePath): ?AmmoParams
    {
        ...
        $radarSystem = simplexml_load_string(file_get_contents($filePath), AmmoParams::class, LIBXML_NOCDATA | LIBXML_NOBLANKS);
