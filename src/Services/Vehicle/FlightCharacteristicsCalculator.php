...
final class FlightCharacteristicsCalculator
{
    ...
    public function calculate(?array $ifcsLoadoutEntry, float $mass, array $thrustCapacity): ?array
    {
        ...
        $flightCharacteristics = [
            ...
            'PitchBoosted' => Arr::get($ifcsParams, 'maxAngularVelocity.x', 0) * Arr::get($ifcsParams, 'afterburner.afterburnAngVelocityMultiplier.x'),
            'YawBoosted' => Arr::get($ifcsParams, 'maxAngularVelocity.z', 0) * Arr::get($ifcsParams, 'afterburner.afterburnAngVelocityMultiplier.z'),
            'RollBoosted' => Arr::get($ifcsParams, 'maxAngularVelocity.y', 0) * Arr::get($ifcsParams, 'afterburner.afterburnAngVelocityMultiplier.y'),
